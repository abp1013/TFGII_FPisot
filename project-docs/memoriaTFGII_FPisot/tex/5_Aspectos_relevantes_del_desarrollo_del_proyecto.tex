...
\section{Puntos de interés con LLM: alucinacionesEn este proyecto, se ha realizado un prototipo con Langflow, que se puede consultar en el archivo \href{https://github.com/fps1001/TFGII_FPisot/blob/main/project-prototypes/Langflow_explanation.md}{Langflow Explanation} para más detalles. En este prototipo se  y optimización de rutas turísticas}
